    ...
    return (
        <div className="min-h-[100dvh] w-full flex flex-col bg-[#020617] text-slate-200 font-sans relative selection:bg-violet-500/30 overflow-y-auto overflow-x-hidden">
            ...
            <div className="relative z-10 w-full flex-1 flex flex-col items-center">
                <div className="flex-1 flex flex-col justify-center items-center w-full max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-20 text-center">
                    <div className="mb-10 sm:mb-14 flex flex-col items-center mt-auto">
                    ...
                    <div className="w-full max-w-xl bg-white/[0.02] backdrop-blur-3xl border border-white/10 p-6 sm:p-12 rounded-[2.5rem] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)] transition-all duration-500 relative group mb-auto">
                ...
                <div className="w-full shrink-0 bg-black/40 border-t border-white/5 py-16 sm:py-24 px-6 relative z-10 backdrop-blur-lg">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                            <div className="bg-white/[0.02] border border-white/5 p-6 sm:p-8 rounded-3xl hover:bg-white/[0.04] transition-colors flex flex-col">
