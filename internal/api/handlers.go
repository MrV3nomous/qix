...
func setAuthCookie(w http.ResponseWriter, token string) {
    ...
    isProd := frontendURL != "" && frontendURL != "http://localhost:5173"

    sameSiteRule := http.SameSiteLaxMode
    if isProd {
        sameSiteRule = http.SameSiteNoneMode
    }
...
func CreateRoomHandler(w http.ResponseWriter, r *http.Request) {
    ...
    // Set the dynamic cookie
    setAuthCookie(w, creatorToken)
